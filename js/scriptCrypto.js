...
(function main(){
    ...
    let questionArray = [
      ...
      {
        question: "Who issues public key certificates? ",
        answers: {
          a: "Certicate Authority",
          b: "Certicate Repository",
          c: "Public Key Authority",
          d: "Certicate Authoriser"
        },
        correctAnswer: "a"
      },
      {
        question: "Including a hidden message in an image is referred to as?",
        answers: {
          a: "Spoofing",
          b: "Plainsight",
          c: "Obsfucation",
      ...
      {
        question: "Alice and Bob are communicating with each other. Eve is intercepting and altering their messages. What is this?",
        answers: {
          a: "Eve in the middle attack",
    ...
    while (myQuestions.length < 3) {
      myQuestions.push(questionArray[Math.floor(Math.random() * 6)]);
